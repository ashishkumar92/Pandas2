...
ft_2 = Font(name='Calibri',color=colors.BLACK, bold=True, size=11,underline='none')
ft_3 = Font(name='Calibri',color=colors.BLUE, bold=True, size=11,underline='none')
